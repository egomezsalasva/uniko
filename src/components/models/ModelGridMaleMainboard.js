...
//Main Component
class ModelGridMaleMainboard extends Component {
    render(){
        ...
        let MODEL_DB_MALE_MAINBOARD = MODEL_DB_MALE_ALL.filter( model => {
        ...
        return (
            ...
            <ModelGridStyle>
                {MODEL_DB_MALE_MAINBOARD.map( (model, i) => {
...
//Export
export default ModelGridMaleMainboard;
