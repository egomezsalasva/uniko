...
//Main Component
class ModelGridFemaleCurvy extends Component {
    render(){
        ...
        let MODEL_DB_FEMALE_CURVY = MODEL_DB_FEMALE_ALL.filter( model => {
        ...
        return (
            ...
            <ModelGridStyle>
                {MODEL_DB_FEMALE_CURVY.map( (model, i) => {
...
//Export
export default ModelGridFemaleCurvy;
